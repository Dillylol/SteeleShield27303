...
// Removed: import org.firstinspires.ftc.robotcore.external.navigation.AngleUnit;
...
public class BjornRC extends OpMode {
    ...
    // IMU (kept initialized, but NOT used for driving anymore)
    private IMU imu;
    ...
    private boolean rbPrev=false, lbPrev=false, dpadUpPrev=false; // removed dpadDownPrev
    ...
    public void init() {
        ...
        // IMU setup (kept, but not used for driving)
        ...
        panels.addData("Status", "Init complete: ToF Scan RPM Assist (robot-centric drive)");
        panels.update();
    }
    ...
    @Override
    public void loop() {
        // ===== Robot-centric drive (NO field-centric transform) =====
        double y  = -gamepad1.left_stick_y;      // forward/back
        double x  =  gamepad1.left_stick_x * 1.1; // strafe (compensate)
        ...
        // (Removed: IMU reset on D-Pad Down — no longer needed for driving)
