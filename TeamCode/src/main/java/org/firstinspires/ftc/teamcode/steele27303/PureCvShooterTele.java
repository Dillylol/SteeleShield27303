...
/**
 * Pure CV AprilTag-enabled shooter TeleOp logic.
 * Removes all laser/TOF dependency and relies solely on CV for distance and aiming.
 */
abstract class PureCvShooterTele extends BjornTele {
    ...
    public void loop() {
        ...
        if (tracking) {
            ...
            solution = new ShooterSolution(cvRpm, thetaDeg, rangeFeet, lateralFeet, obs.id);
        }
    ...
    private void updateToggles() {
        // Manual Shoot Toggle (Left Bumper)
    ...
    private void sendTelemetry(@Nullable TagObservation obs,
        ...
        telemetry.addLine("=== Pure CV Auto Aim ===");
