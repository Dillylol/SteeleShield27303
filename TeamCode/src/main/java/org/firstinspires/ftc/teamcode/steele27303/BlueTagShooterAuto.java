...
public class BlueTagShooterAuto extends BaseTagShooterAuto {
    ...
    private static final Pose SHOOTER = pose(0, -35, 90);

    // Cycle 1
    private static final Pose ROW1 = pose(-15, -47.7, 125.5);
    private static final Pose CAPTURE1 = pose(-31.8, -24.7, 125.5);

    // Cycle 2
    private static final Pose ROW2 = pose(-35, -60, 125.5);
    private static final Pose CAPTURE2 = pose(-50, -38.7, 125.5);

    // Cycle 3
    private static final Pose ROW3 = pose(-55, -71.9, 125.5);
    private static final Pose CAPTURE3 = pose(-70, -52.1, 125);
    ...
    private int stage = 0;
    // Stages:
    // 0: Start -> Shooter (Initial)
    // 1: Aiming & Shooting (Initial)
    ...
    protected double getGlanceHeading() {
        return Math.toRadians(0); // Blue - 90
    }
